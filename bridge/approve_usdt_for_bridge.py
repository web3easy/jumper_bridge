...
usdt_contract = w3.eth.contract(address=Web3.to_checksum_address(token_address), abi=abi)
spender = Web3.to_checksum_address('0x1231deb6f5749ef6ce6943a275a1d3e7486f4eae')
approve_amount = amount

nonce = w3.eth.get_transaction_count(my_address)
gas_price = w3.eth.gas_price
approve_tx = usdt_contract.functions.approve(spender, approve_amount).build_transaction({
    'nonce': nonce,
    'gas': 1000000,
